...
- [ ] 看“尤启鸣”
- [ ] 相机如何构建视锥体？
- [ ] 杨光老师需求：角色进入摄像头视野内，则产生交互

### 19th
- [ ] -16:30 看文倩论文  -20:00 梳理整个行文结构，试着找写作点 / 写提纲/ 初稿
- [ ] 尤启鸣
— [ ] 去迪卡侬看一下？装后尾灯
- [ ] 有空看一下那个深圳标准
...
### 20th
- [ ] 12:30 听，回忆内容
- [ ] 问有无可交互的地理要素 - 尝试给其添加逻辑。
— [ ] 原有地理要素如交通要素的整理拓展属性 / 方法
- [ ] 15：00 看D*lite算法。
- [ ] 查看一些数字孪生案例中的要素交互
...
建筑物、障碍物：建筑物结构、位置，临时障碍物设置，如围栏、路障等。

指示标识和信息传递：导向标识、紧急出口指示牌和实时信息显示屏
...
### 26th
- [ ] 15:00 看完论文，写初稿要点：找参考文献
![alt text](image-11.png)



**行人疏散模型：**
宏观模型以行人流整体特征为研究对象，将行人流看作可压缩的实体或连续 流动的介质，对行人流三要素特征进行分析，重点研究行人流分布及时空演化规 律，分析拥堵和集群现象机理及疏散过程中的自组织现象。
...
**改进D*lite寻路导航算法和改进社会力微观模型**的有效性，以及行人年龄、场景有无引导者、引导者数量对疏散效率的影响。

- [ ] 对整个论文的行文结构进行把握，看文倩小论文第四章节，志辉主要看社会力模型，这边主要看救援，看看有无可以挖掘的科研创新点 / 写作点。（看看xhs攻略）
  - [ ] 看知网论文
  - [ ] 行人反应时间 / 社会力模型的松弛时间
  - [ ] 重点在复杂场景环境设计？D*lite算法
  - [ ] 查询社会力相关分力
  — [ ] 可以自己写一篇论文提纲
  - [ ] 问文倩的问题：主要参考文献
  — [ ] 仿真类设计行人参考参数看文献
...
## 谈话要点
- [ ] 智晖做社会力部分，我做D*lite路径规划部分，文倩场景简单，需要应用到更复杂的，更贴合现实的场景中。
- [ ] 在场景中，负责地理模型标准化和属性设计，属性设计部分作为研究内容，能够实现行人根据要素属性识别到场景中的内容，通过属性做出决策。
- [ ] 查资料找出不同要素可能具有的属性，可能造成的灾害——如交通杆的抗震强度、抗震等级。
- [ ] 研究问题重点：如何设计属性；不同尺度下的表达。
- [ ] 下星期结果：论文思路图、把文倩的内容放到内容中。
...
## 第三章 顾及动态地图的行人疏散路径规划与决策模型
**D*Lite算法**

基于行人密度的 估计函数优化的D*lite算法
