...
https://myetyet.github.io/posts/c42be008/
空间数据库学习
...
![1698203736336](image/数据库/1698203736336.png)
...
语法顺序：
![1698203937956](image/数据库/1698203937956.png)
...
![1698201172209](image/数据库/1698201172209.png)
...
- CONCAT()
  ...
  //MYSQL 字符串函数
  ![1698201119649](image/数据库/1698201119649.png)
- LOWER() / UPPER()
- LENGTH() / CHAR_LENGTH()
- SUBSTRING()
- TRIM()
...
- IFNULL
- CASE
  ![1698203635478](image/数据库/1698203635478.png)
...
![1698201356668](image/数据库/1698201356668.png)

USER()可以查看登录道 mysql 的有哪些用户，以及登录的 IP
![1698201540278](image/数据库/1698201540278.png)
...
![1698204997240](image/数据库/1698204997240.png)
